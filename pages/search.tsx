...
import Property, { IndividualPropertyProp } from '../components/property/Property';
...
const Search: NextPage = ({ properties }:InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  return (
    <Box>
      ...
      <Flex flexWrap="wrap">
        {properties.map((property: IndividualPropertyProp) => <Property key={property.id} property={property}/>)}
      </Flex>
      {properties.length === 0 && (
